using E05.FootballTeamGenerator.Models;
using System;
using System.Collections.Generic;
using System.Linq;

namespace E05.FootballTeamGenerator.Exeptions
{
    public class Engine
    {
        ...
        public void Run()
        {
            ...
            while (inputLine != "END")
            {
                try
                {
                    ...
                    {
                        throw new ArgumentException(string.Format(ExeptionMessages.MissingTeamExeption, teamName));
                    }
                        ...
                        case "Rating":
                            {
                                ...
                                {
                                    throw new ArgumentException(ExeptionMessages.MissingTeamExeption, teamName);
                                }
